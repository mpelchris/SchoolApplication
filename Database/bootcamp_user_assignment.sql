...
CREATE TABLE `user_assignment` (
  ...
  `oralmark` int(11) DEFAULT NULL,
  `totalmark` int(11) DEFAULT NULL,
  PRIMARY KEY (`userid`,`courseid`,`assignmentid`),
  KEY `fk2` (`assignmentid`,`courseid`),
  CONSTRAINT `fk1` FOREIGN KEY (`userid`) REFERENCES `users` (`userid`),
  CONSTRAINT `fk2` FOREIGN KEY (`assignmentid`, `courseid`) REFERENCES `assignments` (`assignmentid`, `courseid`)
...
INSERT INTO `user_assignment` VALUES (8,3,7,0,0);
...
-- Dump completed on 2019-06-11 14:27:06
